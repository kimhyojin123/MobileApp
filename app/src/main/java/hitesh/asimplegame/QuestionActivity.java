...
public class QuestionActivity extends Activity {
    ...
    public int getQuestionID(int stageid){
        if(stageid==11) return 1;
        if(stageid==12) return 21;
        if(stageid==13) return 41;
        if(stageid==14) return 61;
        if(stageid==15) return 81;
        if(stageid==21) return 101;
        if(stageid==22) return 121;
        if(stageid==23) return 141;
        if(stageid==24) return 161;
        if(stageid==25) return 181;
        if(stageid==31) return 201;
        if(stageid==32) return 221;
        if(stageid==33) return 241;
        if(stageid==34) return 261;
        if(stageid==35) return 281;
        else return 0;
    }
